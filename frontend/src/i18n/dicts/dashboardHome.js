export default {
  "uk": {
    ...
    "welcomeSub": "Ласкаво просимо до екосистеми UpDown / AiView",
    "expiresIn": "Закінчується за",
    "days": "днів",
    "getStarted": "Оберіть план",
  ...
  "en": {
    "welcome": "Welcome",
    "welcomeSub": "Welcome to the UpDown / AiView ecosystem",
  ...
  "ru": {
    ...
    "welcomeSub": "Добро пожаловать в экосистему UpDown / AiView",
  ...
  "de": {
    "welcome": "Willkommen",
    "welcomeSub": "Willkommen im UpDown / AiView Ökosystem",
    "expiresIn": "Läuft ab in",
    "days": "Tagen",
    "getStarted": "Tarif wählen",
  ...
  "es": {
    "welcome": "Bienvenido",
    "welcomeSub": "Bienvenido al ecosistema UpDown / AiView",
    "expiresIn": "Expira en",
    "days": "días",
  ...
  "it": {
    "welcome": "Benvenuto",
    "welcomeSub": "Benvenuto nell'ecosistema UpDown / AiView",
    "expiresIn": "Scade tra",
    "days": "giorni",
    "getStarted": "Scegli un piano",
  ...
  "pt": {
    "welcome": "Bem-vindo",
    "welcomeSub": "Bem-vindo ao ecossistema UpDown / AiView",
    "expiresIn": "Expira em",
    "days": "dias",
    "getStarted": "Escolher um plano",
  ...
  "zh": {
    "welcome": "欢迎",
    "welcomeSub": "欢迎来到 UpDown / AiView 生态系统",
    "expiresIn": "到期时间：",
    "days": "天后",
    "getStarted": "选择套餐",
    "products": "您的产品",
  ...
  "ar": {
    "welcome": "مرحباً",
    "welcomeSub": "مرحباً بك في منظومة UpDown / AiView",
    "expiresIn": "ينتهي خلال",
    "days": "يوم",
    "getStarted": "اختر باقة",
    "products": "منتجاتك",
    "upgrade": "ترقية",
    "active": "مفعّل",
